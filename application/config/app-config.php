...
*
*/
define('APP_BASE_URL', 'https://gestao.sigahelp.com.br/');
...
*/
define('APP_ENC_KEY', 'f905531dcaa58e2746d46aa5cc0be54e');
 ...
 */
define('APP_DB_USERNAME', 'sigahe43_gestao');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'Tg@13062020');

/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'sigahe43_gestao');
